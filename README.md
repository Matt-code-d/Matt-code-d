...
- [Wakaruyo - Japanese Text Translation Browser Extension](https://dev.to/matteosant_dev/wakaruyo-browser-extension-4b7i)
...
- [Disney Gargoyles native porting Development Update](https://dev.to/matteosant_dev/gargoyles-remake-development-update-44il)
- [Introducing My Secure Password Generator App VUE JS + Bulma](https://dev.to/matteosant_dev/introducing-my-secure-password-generator-app-vue-js-bulma-e3j)
<!-- BLOG-POST-LIST:END -->
